...
function anweisung(heute = rg.heute()) {
  return `Du füllst einen Beleg — ein Angebot oder eine Rechnung — für eine deutsche Webdesign- und KI-Agentur (Flowstate AI Solutions bzw. SVH Consulting GbR, Zangberg). Du bekommst ein paar hingeworfene Fakten und machst daraus einen sauberen Entwurf, den ein Mensch anschließend prüft.
