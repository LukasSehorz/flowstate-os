...
const FRISCH = /\b(tabelle|tabellenplatz|platz|punkte|spielt?ag|spiel|spiele|gespielt|ergebnis|ergebnisse|gewonnen|verloren|unentschieden|torverh|liga|saison|kurs|aktien|preis|kostet|kosten|wetter|heute|gestern|wochenende|aktuell\w*|gerade|momentan|jetzt|neueste|letzte[nrs]?|news|nachrichten)\b/i;
...
const ZUSATZBEGRIFFE = [
  ...
  [/\b(tabelle|tabellenplatz|platz|rang|steht|punkte)\b/i,
    ["Tabellenplatz", "Punkte", "Pkt", "Pl.", "Torverh", "Sp."]],
  [/\b(einwohner|bev[öo]lkerung)\b/i, ["Einwohner", "Bevölkerung"]],
  [/\b(kostet|preis|kosten|teuer)\b/i, ["Preis", "Euro", "€"]],
