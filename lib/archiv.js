...
//
// optionen.namenBelassen (05.09.2026): Namen unveraendert uebernehmen, nur
// Dubletten durchzaehlen. Gebraucht von lib/xlsx-schreiben.js — ein Office-
// Paket verlangt den Eintrag "_rels/.rels", und pfadSicher() wuerde den
// fuehrenden Punkt entfernen. Fuer den Monatsordner bleibt es beim Entschaerfen:
// dort kommen die Namen von hochgeladenen Dateien, hier vom eigenen Code.
module.exports.zip = function (eintraege, stand = new Date(), optionen = {}) {
  ...
  for (const e of eintraege) {
    ...
    let name = optionen.namenBelassen ? String(e.name) : module.exports.pfadSicher(e.name);
