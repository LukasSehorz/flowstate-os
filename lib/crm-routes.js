...
Wiese Elektroanlagen	Elektriker	Karlsfelder Str. 35	80995	München	+49 89 3149357			wiese-elektroanlagen.de"></textarea>
            ...
            <div><label style="margin-top:12px">Name dieser Liste</label>
              <input id="ln-liste-name" maxlength="80"
                placeholder="z. B. GF-Handy Bayern (leer = Datum und Uhrzeit)">
              <p class="sub" style="margin:4px 0 0">Danach lässt sich die Liste oben
                als Ganzes filtern — unabhängig von der Branche.</p></div>
          </div>
  ...
  app.post("/crm/leads/neu", async (req, res, next) => {
    try {
      ...
      const r = await crm.leadsAnlegen(req.nutzer, leads, { sparte, branche, besitzer, listenName });
