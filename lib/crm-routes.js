...
// am Modul "Kunden & CRM".
const SCHALE_ID = { start: "crm-start", leads: "crm-leads", kunden: "crm-kunden", team: "crm-team" };

function rahmen(user, aktiv, titel, unterzeile, reiter, inhalt, sparte) {
  const id = aktiv === "pipeline"
    ? ({ webdesign: "crm-webdesign", performance: "crm-performance", ki: "crm-ki" }[sparte] || "crm-webdesign")
    : SCHALE_ID[aktiv] || "crm";
  return schale({
    titel, unterzeile, reiter, inhalt, nutzer: user, aktiv: id,
