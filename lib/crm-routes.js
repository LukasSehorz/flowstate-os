      ...
      res.send(rahmen(u, istKunde ? "kunden" : "leads", istKunde ? "Kundenakte" : "Lead-Akte", "", "", `
        ...
        <div class="seiten-kopf akte-kopf">
          ...
          <div class="akte-kopf-rechts">
            ...
            ${istKunde ? `<form method="post" action="${mitHerkunft(`/crm/firma/${f.id}/zu-lead`, zurueck)}"
                   onsubmit="return confirm('${e(f.name).replace(/'/g, "&#39;")}: Kundenakte entfernen und zurück zu Lead?')">
                   <button type="submit" class="knopf still" title="Falls die Kundenakte irrtümlich angelegt wurde">Zurück zu Lead</button></form>` : ""}
          </div>
        </div>
          ...
          <div class="akte-spalten"><div class="akte-spalte">
            <div class="karte"><div class="karte-kopf"><h2>Stammdaten</h2></div>
              ...
              <input type="hidden" name="dabei" value="kontakt" form="akte">
                <div class="feld"><label>Telefon (Festnetz)</label>
                  <input form="akte" name="telefon" type="tel" value="${e(f.telefon || "")}" placeholder="+49 89 …"></div>
                <div class="feld"><label>Handy</label>
                  <input form="akte" name="mobil" type="tel" value="${e(f.mobil || "")}" placeholder="+49 172 … (Geschäftsführer direkt)"></div>
            ...
            <div class="karte karte-termine"><div class="karte-kopf"><div><h2>Dringlichkeit &amp; Termine</h2>
              ...
              <input type="hidden" name="dabei" value="termine" form="akte">
                ...
                <div class="feld-paar">
                  ${/* Mit Uhrzeit (0051): Ein Erstgespraech ist ein Termin im
                       Kalender, kein Stichtag. Ohne Uhrzeit stand auf der Karte
                       nur der Tag, und wer wissen wollte, wann genau, musste die
                       Gespraechsnotiz aufmachen. */""}
                  <div class="feld"><label>Erstgespräch am</label>
                    <input form="akte" type="datetime-local" name="erstgespraech_am"
                      value="${datumZeitFeld(f.erstgespraech_am)}"></div>
