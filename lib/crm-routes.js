      ...
      res.send(rahmen(u, "leads", "Leads", `Cold-Calling-Liste · ${e(SPARTEN[sparte])}`, reiter, `
        ...
        <dialog id="lead-neu-dlg" class="lead-neu-dialog">
          ...
          <div id="lead-liste" style="display:none">
            ...
            <textarea id="ln-liste" rows="8" placeholder="Firma	Ort	Berufsbezeichnung	Geschäftsführer	Telefon	Website
Physiotherapie Sonnenhof	München	Physiotherapie	Andrea Sonnleitner	+49 89 4412088	sonnenhof.de"></textarea>
            <div class="lead-neu-spalten" style="margin-top:10px">Spalten in dieser Reihenfolge:
              Firma &nbsp;·&nbsp; Ort &nbsp;·&nbsp; Berufsbezeichnung &nbsp;·&nbsp; Geschäftsführer &nbsp;·&nbsp; Telefon &nbsp;·&nbsp; Website<br>
              <span style="font-weight:400">Nur <b>Firma</b> ist Pflicht. Fehlt eine Spalte hinten, lass sie weg.
