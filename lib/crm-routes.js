...
module.exports = function (app) {
  ...
  app.get("/crm", async (req, res, next) => {
    try {
      ...
      // Aus der Graphit-Rampe des Deko-Objekts (siehe Kopf von public/crm.css) — dieselbe
      // Achse wie Karten, Trichter und Navigationsleiste, damit der Ring nicht als
      // Fremdkoerper auf der Karte liegt. Von schwarz nach hell, deutlich getrennte Stufen.
