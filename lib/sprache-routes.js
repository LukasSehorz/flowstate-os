...
function denkAnfrage(text) {
  ...
  const system =
    ...
    `Antworte in 1-3 Saetzen mit dem Ergebnis — kein Vorwort, keine Quellen-URLs, ` +
    `keine Aufzaehlung von Suchschritten. Nur was Lukas wissen will.`;
  return schnell.denke(system, text, { maxTokens: 500, timeoutMs: 35000 })
