...
<section class="gh" id="gh-buehne" data-zustand="ruhe">
  ...
  <div class="gh-kopf">
    <div class="gh-marke">
      ...
      <span id="kugel-wort">ALEXANDRA</span>
  ...
  <div class="gh-fuss">
    ...
    <div id="kugel-hinweis" aria-live="polite">Zweimal klatschen — oder „Hey Alexandra“ sagen</div>
    ...
    <div class="gh-leiste" role="group" aria-label="Sprachsteuerung">
      ...
      <button id="btn-wake" class="vx-tool" type="button"
              title="Dauerhaft auf „Hey Alexandra“ lauschen">Wake<span class="vx-dot" id="wake-punkt"></span></button>
