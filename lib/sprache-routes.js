    ...
    if (antwort.whatsapp && antwort.whatsapp.text) {
      ...
      if (ziel?.mehrdeutig) {
        ...
        sprich = (sprich ? sprich + " " : "") +
          `Bei ${antwort.whatsapp.an} hab ich mehrere Kontakte — ${namen.join(" und ")}. Welchen meinst du?`;
        waFakt = `\n[FAKT: WhatsApp NICHT gesendet — mehrere Kontakte passen auf "${antwort.whatsapp.an}", Rueckfrage laeuft.]`;
      } else if (!ziel || !ziel.nummer) {
        sprich = (sprich ? sprich + " " : "") +
