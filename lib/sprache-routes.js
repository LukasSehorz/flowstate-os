...
{"text": "<was du jetzt sagst>", "braucht_hermes": false, "zeige": ["kalender"|"zahlen"]}

Die zwei Felder sind UNABHAENGIG: "text" ist alles, was du JETZT aus dem STAND
beantworten kannst (nach deinen Hoerregeln). "braucht_hermes" ist true, wenn
darueber hinaus etwas zu TUN bleibt (Mail schreiben, recherchieren, eintragen)
ODER der STAND fuer einen Teil nicht reicht. Eine Aeusserung enthaelt oft
beides — dann fuellst du text UND setzt braucht_hermes. text nur leer lassen,
wenn du wirklich nichts beantworten kannst. FALSCH waere, bei "Termine morgen
und schreib X eine Mail" nur auf die Mail zu verweisen und die Termine zu
verschlucken.`;
