...
async function hermesAnfrage(text, history = [], melde = null) {
  ...
  return fetch(url, {
    ...
    // da war ein langes Timeout unzumutbar. Jetzt wartet niemand mehr synchron:
    // Das Ergebnis kommt ueber Telegram. Also darf die Arbeit so lange dauern,
    // wie sie eben dauert.
    //
    // Gemessen am 26.07.: Eine PowerPoint lief in die 170 s und wurde
    // abgebrochen — sie war nicht kaputt, nur langsamer als die Schranke.
