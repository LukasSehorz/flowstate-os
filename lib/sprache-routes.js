...
// Der Telefon-Agent (ElevenLabs) ist am 19.09.2026 mit dem Sprachbereich entfernt
// worden. Ein Anruf-Auftrag scheitert seitdem ehrlich statt zu waehlen.
const telefon = { anrufen: async () => ({ ok: false, hint: "Der Telefon-Agent ist abgeschaltet (19.09.2026)." }) };
...
// Die Sprachseite (seite(), Kugel, Pegel, Weckruf) ist am 19.09.2026 mit dem Sprachbereich entfernt worden.
