...
//
// Ohne Schluessel in ANTHROPIC_API_KEY ist das Modul still: bereit() gibt false,
// der Belegeingang funktioniert weiter, die Felder sind dann eben leer. Der
// Ablauf haengt also nicht daran.
...
module.exports.lesen = async function (beleg, kategorien) {
  const c = hol();
  if (!c) return { ok: false, hinweis: "Kein Zugang zum Lesedienst hinterlegt (ANTHROPIC_API_KEY fehlt)." };
