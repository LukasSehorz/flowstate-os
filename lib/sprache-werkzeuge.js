...
const WERKZEUGE = [
  ...
  // --- Nachrichten.
  w("whatsapp_senden",
    "WhatsApp vorbereiten. Der Server formuliert aus, liest vor und holt die Freigabe. Kein Serienversand an viele.",
    {
      an: txt("Name oder Gruppenname — Kontakte loest der Server auf, du brauchst nie eine Nummer"),
      text: txt("die ABSICHT, nicht der Wortlaut: 'schreib Jannik, wann er wieder da ist' -> 'frag Jannik, wann er wieder im Buero ist'"),
