...
const WERKZEUGE = [
  ...
  w("beleg_erstellen",
    "Rechnung oder Angebot schreiben — Lukas' Vorlage, naechste Nummer. Nach der Mail fragt der Server selbst. Fehlt etwas, frag NACH statt zu raten: Das geht an einen echten Kunden.",
    {
      ...
      leistung: txt("ganzer Satz mit Firmenname: 'Erstellung einer professionellen Website fuer die Mueller GmbH inkl. responsivem Design, SEO und Go-Live.'"),
