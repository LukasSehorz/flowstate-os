...
async function denke(system, nutzer, { webSuche = true, maxTokens = 700, timeoutMs = 30000 } = {}) {
  ...
  if (webSuche) anfrage.tools = [{ type: "web_search_20260209", name: "web_search", max_uses: 3 }];
