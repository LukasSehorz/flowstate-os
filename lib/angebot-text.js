...
const SYSTEM = `Du schreibst Angebote für Flowstate AI Solutions (Sehorz Lukas, vom Hofe Jannik GbR) aus Zangberg — Webdesign, SEO, KI-Suchoptimierung, Social Media.
...
async function schreiben({ firma, projekt, sparte, betrag, ansprechpartner, ort }) {
  const nutzer = [
    `Kunde: ${firma}`,
