...
function nameZuJid(jid, rueckfall = "") {
  ...
  if (id.endsWith("@g.us")) {
    ...
    // KEIN Rueckfall auf "rueckfall": Bei eingehenden Nachrichten reicht der
    // Aufrufer die Nummer des SCHREIBERS durch, und die ist niemals der
    // Gruppenname. Am 27.07. las Alexandra deshalb "in der Gruppe 84564" vor —
    // eine Nummernendung, kein Name. Kennt die Bruecke die Gruppe nicht, wird
    // sie ehrlich unbenannt genannt.
    return "einer Gruppe";
  }
  try {
