...
// ------------------------------------------------------------------ Absender
//
// ZWEI Briefkoepfe mit EINEM Namen (19.09.2026): Seit der Umbenennung heisst
// die Firma svh Consulting, Angebote wie Rechnungen. Bis dahin gingen Angebote
// unter "Flowstate AI Solutions" (05.09.2026, aus Lukas' Ordner
// ~/…/Webseiten/Sale/Rechnungen ausgelesen). Beide Briefkoepfe bleiben getrennt,
// weil Kontakt, Konto und Unterschrift sich unterscheiden — beide
...
const ABSENDER_VORGABE = {
  ...
  angebot: {
    logo1: "SVH", logo2: "CONSULTING", claim: "Webdesign · SEO · KI-Suchoptimierung",
    name: "svh Consulting", rechtsform: "Sehorz Lukas, vom Hofe Jannik GbR",
    strasse: "Am Anger 3", plz_ort: "84539 Zangberg", ort: "Zangberg",
