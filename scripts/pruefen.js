...
const TESTS = [
  ...
  "test-wa-arten", "test-neuigkeiten", "test-nachschlagen", "test-dokument", "test-zustand-frische", "test-crm-sprache", "test-zufluss-telegram", "test-beleg-telegram", "test-beleg-vorlage", "test-beleg-erstellen", "test-mail-anhang", "test-mail-belege",
];
